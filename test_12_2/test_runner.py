...
class TournamentTest(unittest.TestCase):
    ...
    def test_race_1(self):
        ...
        self.all_results[1] = results  # Store results with race number
    ...
    def test_race_2(self):
        ...
        results = tournament.start()
        self.all_results[2] = results  # Store results with race number
    ...
    def test_race_3(self):
        ...
        results = tournament.start()
        self.all_results[3] = results  # Store results with race number
        self.assertTrue(results[1].name == "Усэйн", "Expected winner is Усэйн")
